...
#>
param(
    [string[]]$Scenes = @("port", "port_damage", "port_crew_tired", "port_crew_training", "port_worn", "port_cargo_bay", "port_cargo_bay_low_funds", "port_services", "port_services_low_funds", "port_services_no_materials", "port_services_full_cells", "port_loadouts", "port_repair_low_funds", "port_repaired", "port_preview", "port_refinery", "logbook", "sites", "sites_contract_streak", "sites_route_familiarity", "sites_crew_progress", "sites_crew_veteran", "sites_progress", "sites_private_haul", "travel", "travel_cargo_bay", "travel_familiarity", "travel_cruise", "travel_scanner", "salvage_scan", "salvage_route_familiarity", "salvage_power", "salvage_power_cell_log", "salvage_clearance", "salvage_scanner", "salvage_drones", "salvage_drone_orders", "salvage_drones_log", "salvage_stabilize", "salvage_stabilized", "salvage_log", "salvage_revisit", "salvage_notice", "salvage_hazard_notice", "salvage_shift", "salvage_arrival", "salvage_extract", "salvage_capture", "salvage_clamp", "salvage_tow", "salvage_military", "salvage_research", "packing", "packing_private_haul", "return_travel", "return_travel_private_haul", "results", "results_private_haul", "paused"),
    [int]$Frames = 150,
