...
#>
param(
    [string[]]$Scenes = @("port", "port_preview", "port_refinery", "logbook", "sites", "sites_progress", "travel", "travel_cruise", "travel_scanner", "salvage_scan", "salvage_power", "salvage_clearance", "salvage_scanner", "salvage_drones", "salvage_drones_log", "salvage_stabilize", "salvage_stabilized", "salvage_log", "salvage_revisit", "salvage_notice", "salvage_hazard_notice", "salvage_shift", "salvage_arrival", "salvage_extract", "salvage_capture", "salvage_clamp", "salvage_tow", "salvage_military", "salvage_research", "packing", "return_travel", "results", "paused"),
    [int]$Frames = 150,
