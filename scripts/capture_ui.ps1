...
#>
param(
    [string[]]$Scenes = @("port", "port_preview", "sites", "sites_progress", "travel", "travel_cruise", "salvage_scan", "salvage_revisit", "salvage_notice", "salvage_hazard_notice", "salvage_shift", "salvage_arrival", "salvage_extract", "salvage_capture", "salvage_clamp", "salvage_tow", "salvage_military", "salvage_research", "packing", "results", "paused"),
    [int]$Frames = 150,
