...
#>
param(
    [string[]]$Scenes = @("port", "port_preview", "sites", "travel", "travel_cruise", "salvage_scan", "salvage_extract", "salvage_capture", "salvage_military", "salvage_research", "packing", "results", "paused"),
    [int]$Frames = 150,
