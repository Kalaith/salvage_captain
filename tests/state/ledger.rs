//! Voyage record construction and save-history rules.

use crate::data::{GameData, GridPosition};
use crate::engine::{RiskOutcome, RiskResult};
use crate::state::{
    CargoStatus, GameSession, ReturnedItem, VoyageRecord, VoyageRecordInput, WorkspaceLogEvent,
...
fn completed_voyage_records_returned_value_and_outcome() {
    ...
    session.record_voyage(VoyageRecordInput {
        ...
        return_policy: crate::state::ReturnPolicy::ProtectValue,
