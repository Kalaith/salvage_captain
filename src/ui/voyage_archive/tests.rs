...
fn career_summary_names_the_lifetime_dossier() {
    ...
    assert_eq!(
        ...
        (
            "OPERATING LEDGER  //  REPAIRS 2 F/H/S 2/0/0  //  SYSTEMS 2  //  SERVICE ¢195  //  HOLD +1  //  CREW QUALIFIED 0/5  //  CONTRACT STREAK 0/0  //  CELLS BUY +0 / MAKE 0 / USE -0".to_owned(),
